namespace ProyectoFinalC_
{
    partial class FormGrafos
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2 = new Label();
            label3 = new Label();
            btnRecorridoBFS = new Button();
            listRecorridoBFS = new ListView();
            SuspendLayout();
            // 
            // btnAgregarVertice
            // 
            ...
            listGrafo.Location = new Point(27, 227);
            listGrafo.Name = "listGrafo";
            listGrafo.Size = new Size(118, 199);
            ...
            listBoxMatrizAdyacencia.Location = new Point(187, 253);
            listBoxMatrizAdyacencia.Name = "listBoxMatrizAdyacencia";
            listBoxMatrizAdyacencia.Size = new Size(267, 184);
            listBoxMatrizAdyacencia.TabIndex = 6;
            // 
            // listRecorridoDFS
            // 
            listRecorridoDFS.Location = new Point(486, 254);
            listRecorridoDFS.Name = "listRecorridoDFS";
            listRecorridoDFS.Size = new Size(126, 184);
            ...
            // btnRecorridoBFS
            // 
            btnRecorridoBFS.Location = new Point(538, 194);
            btnRecorridoBFS.Name = "btnRecorridoBFS";
            btnRecorridoBFS.Size = new Size(97, 29);
            btnRecorridoBFS.TabIndex = 15;
            btnRecorridoBFS.Text = "Recorrido BFS";
            btnRecorridoBFS.UseVisualStyleBackColor = true;
            btnRecorridoBFS.Click += btnRecorridoBFS_Click;
            // 
            // listRecorridoBFS
            // 
            listRecorridoBFS.Location = new Point(629, 253);
            listRecorridoBFS.Name = "listRecorridoBFS";
            listRecorridoBFS.Size = new Size(128, 184);
            listRecorridoBFS.TabIndex = 16;
            listRecorridoBFS.UseCompatibleStateImageBehavior = false;
            // 
            // FormGrafos
            // 
            ...
            Controls.Add(listRecorridoBFS);
            Controls.Add(btnRecorridoBFS);
            Controls.Add(label3);
            Controls.Add(label2);
            Controls.Add(label1);
        ...
        private Button btnRecorridoBFS;
        private ListView listRecorridoBFS;
    }
}